...
const Banner = () => {
  return (
    <div className="parent min-h-[100vh] flex flex-col-reverse lg:flex-row items-center justify-between">
      ...
      >
        <h1 className="mb-0 text-4xl font-bold">PT Tritek Indonesia</h1>
        ...
        <p className="max-w-md mb-10 font-medium text-accent">
          PT Tritek Indonesia adalah perusahaan penyedia layanan jasa pembuatan Website, Aplikasi Mobile, Branding & Konten Kreatif, serta Internet Marketing & Advertising sesuai kebutuhan bisnis anda dengan harga murah kualitas mewah.
        </p>
